# Contributing to cellpose_plus

We welcome you to [check the existing issues](https://github.com/ITMO-MMRM-lab/cellpose_plus/issues) for bugs or enhancements to work on.
If you have an idea for an extension to cellpose_plus, please [file a new issue](https://github.com/ITMO-MMRM-lab/cellpose_plus/issues/new) so we can discuss it.

Make sure to familiarize yourself with the project layout before making any major contributions.

## How to contribute

1. Fork the [project repository](https://github.com/ITMO-MMRM-lab/cellpose_plus/): click on the 'Fork' button near the top of the page. This creates a copy of the code under your account on the GitHub server.

2. Clone this copy to your local disk:

   ```bash
   git clone git@github.com:YourUsername/cellpose_plus.git
   ```
...
Finally, go to the web page of your fork of the cellpose_plus repo, and click
...
If your contribution changes cellpose_plus in any way:

- Update the [documentation](https://github.com/ITMO-MMRM-lab/cellpose_plus/tree/main/docs) so all of your changes are reflected there.

- Update the [README](https://github.com/ITMO-MMRM-lab/cellpose_plus/tree/main/paper/v3_0/README.md) if anything there has changed.

If your contribution involves any code changes:

- Update the [project tests](https://github.com/ITMO-MMRM-lab/cellpose_plus/tree/main/tests) to test your code changes.
