...
about: Want us to add any features to cellpose_plus?
title: 'enh: '
labels: enhancement
assignees: ''
...
<!--
  Hi! Thanks for considering to file a feature request with cellpose_plus. Please take the time to
...
<!--
  Why do you want to see this feature in cellpose_plus? What use cases does it support?
-->
