...
class CellposeDenoiseModel:
    ...
    def __init__(
        ...
        """
        Initializes the model with specified parameters for processing.

        Args:
            gpu: Indicates whether to use a GPU for computation.
            pretrained_model: The path or name of the pretrained model to be loaded.
            nchan: The number of channels for input data.
            model_type: The type of model to be used.
            chan2: Indicates if a second channel model should be loaded.
            diam_mean: The mean diameter for the model.
            device: The device on which the model should be loaded (e.g., CPU or GPU).

        Returns:
            None. This method initializes the internal state and creates the model.
        """
...
class DenoiseModel:
    ...
    def __init__(
        ...
        """
        Initialize the model with specified parameters for denoising and cell pose estimation.

        Args:
            gpu: Flag indicating whether to use GPU for processing.
            pretrained_model: Flag indicating whether to use a pretrained model for cell pose estimation.
            model_type: Type of model to be used for cell pose estimation.
            restore_type: Type of restoration model to be used for denoising.
            nchan: Number of channels to use in the cell pose model.
            chan2_restore: Flag indicating whether to restore the second channel.
...
def train(
    ...
    """
    Trains a neural network model using the provided training and testing datasets.

    Args:
        net: The neural network model to be trained.
        train_data: The input data for training (optional).
        train_labels: The labels corresponding to the training data (optional).
        train_files: List of file paths to training data if train_data is not provided (optional).
        test_data: The input data for testing (optional).
        test_labels: The labels corresponding to the test data (optional).
        test_files: List of file paths to testing data if test_data is not provided (optional).
        train_probs: Probabilities for selecting training images (optional).
        test_probs: Probabilities for selecting test images (optional).
        lam: Regularization parameters for the loss function.
        scale_range: Range for scaling the input images.
        seg_model_type: The type of segmentation model to use.
        save_path: Directory path where model checkpoints will be saved (optional).
        save_every: The interval (in epochs) at which to save model checkpoints.
        save_each: Boolean indicating whether to save after each epoch.
        poisson: Noise parameters for the training images.
        beta: Noise parameters affecting the model's learning.
        blur: Amount of blur applied to the images.
        gblur: Gaussian blur factor.
        iso: Boolean indicating whether to apply isotropic transformations.
        uniform_blur: Boolean indicating whether to apply uniform blur.
        downsample: Factor by which to downsample the training images.
        ds_max: Maximum downsampling factor.
        learning_rate: Initial learning rate for the optimizer.
        n_epochs: Number of epochs to train the model.
        weight_decay: Weight decay parameter for regularization.
        batch_size: Number of samples per gradient update.
        nimg_per_epoch: Number of images to process per training epoch (optional).
        nimg_test_per_epoch: Number of images to process per testing epoch (optional).
        model_name: Name for the saved model (optional).

    Returns:
        A tuple containing the path to the saved model, a list of training losses, and a list of testing losses.
    """
