...
def check_clockwise(polygon):
    """
    Checks if the given polygon's vertices are oriented in a clockwise direction.

    Args:
        polygon: A list of tuples representing the vertices of the polygon, where each tuple contains the x and y coordinates of a vertex.
