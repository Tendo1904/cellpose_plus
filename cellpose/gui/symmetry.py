...
def check_clockwise(polygon):
    ...
    Determines the orientation of a polygon.
        ...
        This method checks if the given polygon's vertices are arranged in
        a clockwise direction. It calculates the signed area of the polygon
        formed by the vertices and returns an indicator of the orientation.

        Args:
            polygon: A list of tuples, where each tuple represents the (x, y)
                     coordinates of a vertex of the polygon. The vertices should
                     be ordered either clockwise or counterclockwise.

        Returns:
            An integer indicating the orientation of the polygon. Returns -1 if
            the vertices are arranged in a counterclockwise direction, and 1 if
