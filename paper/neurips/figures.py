...
def fig1(imgs_norm, masks_true, dat, timings, save_fig=False):
    """
    Creates and displays a figure with validation images and performance metrics for different segmentation models.

    Args:
        imgs_norm: Normalized images to be displayed.
        masks_true: True masks corresponding to the images for comparison.
        dat: A dictionary containing performance data for different models.
        timings: A 2D array of runtime timings for each model.
        save_fig: A boolean flag indicating if the figure should be saved as a PDF.

    Returns:
        None: The method displays a figure and optionally saves it to a file.
    """
...
def fig2(imgs_norm, masks_true, dat, type_names, types, emb, emb_test, save_fig=False):
    """
    Generates and saves a figure for visual comparison of images, ground truth outlines, and model predictions.

    Args:
        imgs_norm: Normalized images to be displayed.
        masks_true: Ground truth masks for the images.
        dat: A dictionary containing model predictions and F1 scores per image.
        type_names: A list of type names corresponding to the embeddings.
        types: A list of type indices corresponding to the embeddings.
        emb: Embeddings for the images.
        emb_test: Testing embeddings for comparison.
        save_fig: A boolean indicating whether to save the generated figure or not.
