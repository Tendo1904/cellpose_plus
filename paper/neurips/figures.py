...
def fig1(imgs_norm, masks_true, dat, timings, save_fig=False):
    """
    Generates a figure to visualize the performance of different models on a given set of images and masks.

    Args:
        imgs_norm: Normalized images to display.
        masks_true: Ground truth masks corresponding to the images.
        dat: A dictionary containing model results, including thresholds and F1 scores for different models.
        timings: A 2D array containing runtime information for different model types.
        save_fig: Optional flag to save the generated figure as a PDF file.
...
def fig2(imgs_norm, masks_true, dat, type_names, types, emb, emb_test, save_fig=False):
    """
    Generates and saves visualization figures for image segmentation results comparing ground truth and model outputs.

    Args:
        imgs_norm: Normalized images to be displayed.
        masks_true: Ground truth masks corresponding to the images.
        dat: A dictionary containing model output data and evaluation metrics.
        type_names: Names associated with different image types.
        types: Array indicating the type of each image.
        emb: Embedding features for the images used in t-SNE visualization.
        emb_test: Test embeddings for separate visualization.
        save_fig: A boolean indicating whether to save the resulting figure as a PDF.
