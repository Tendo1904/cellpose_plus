...
def get_pretrained_models(
    ...
    """
    Retrieve a list of pretrained model file paths based on specified configuration parameters.

    Args:
        model_root: The root directory where the models are stored.
        unet: Flag indicating whether to use UNet (default is 0 for 'off').
        nclass: Number of classes for the model (default is 3).
        residual: Flag indicating whether to include residual connections (default is 1 for 'on').
        style: Style parameter for the model (default is 1 for 'on').
        concatenate: Flag indicating whether to use concatenation (default is 0 for 'off').

    Returns:
        A list of model file paths that match the constructed pattern.
    """
    sstr = ["off", "on"]
