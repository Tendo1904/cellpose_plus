...
def suppfig_cellpose_params(test_root, save_root, save_figure=False):
    """
    Generate supplementary figures for Cellpose model parameters and performance.

    Args:
        test_root: The directory containing the test images and masks.
        save_root: The directory where the computed results and figures will be saved.
        save_figure: A boolean indicating whether to save the generated figure to disk.
...
def cyto3d(save_root, save_figure=True):
    """
    Generates and saves a 3D performance figure comparing various model architectures based on average precision metrics.

    Args:
        save_root: The directory path where the ground truth masks and model masks are located, as well as where the figure will be saved.
        save_figure: A boolean flag indicating whether to save the generated figure as a PDF file.
