...
def suppfig_cellpose_params(test_root, save_root, save_figure=False):
    """
    Generates and saves a supplementary figure comparing cellpose model performance parameters.

    Args:
        test_root: Directory path where test images and masks are located.
        save_root: Directory path where the cellpose data and figures will be saved.
        save_figure: Boolean flag to indicate whether to save the generated figure.
...
def cyto3d(save_root, save_figure=True):
    """
    Generates and saves a 3D performance plot for various segmentation models using average precision metrics.

    Args:
        save_root: Path to the directory where the ground truth masks and model predictions are stored.
        save_figure: Flag indicating whether to save the generated figure as a PDF file.

    Returns:
        None: This method does not return any value but saves a figure if requested.
    """
